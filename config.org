...
#+BEGIN_QUOTE
NOTE: If running on EvieMacStudio, the ZMK Build Environment is already setup, however, instructions can be found in [[file:readme.org::*Local Builds][Local Builds]], if needed.
#+END_QUOTE
